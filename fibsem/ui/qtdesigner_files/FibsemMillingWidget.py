...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 545, 809))
        ...
        self.gridLayout_3.addWidget(self.doubleSpinBox_spacing, 8, 1, 1, 1)
        self.label_preset = QtWidgets.QLabel(self.groupBox_milling_settings)
        self.label_preset.setObjectName("label_preset")
        self.gridLayout_3.addWidget(self.label_preset, 9, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.comboBox_application_file, 3, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.label_application_file, 3, 0, 1, 1)
        self.label_rate = QtWidgets.QLabel(self.groupBox_milling_settings)
        self.label_rate.setObjectName("label_rate")
        self.gridLayout_3.addWidget(self.label_rate, 5, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.doubleSpinBox_rate, 5, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.comboBox_patterning_mode, 4, 1, 1, 1)
        self.label_voltage = QtWidgets.QLabel(self.groupBox_milling_settings)
        self.label_voltage.setObjectName("label_voltage")
        self.gridLayout_3.addWidget(self.label_voltage, 0, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.doubleSpinBox_hfw, 2, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.comboBox_preset, 9, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.label_milling_current, 1, 0, 1, 1)
        self.label_hfw = QtWidgets.QLabel(self.groupBox_milling_settings)
        self.label_hfw.setObjectName("label_hfw")
        self.gridLayout_3.addWidget(self.label_hfw, 2, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.label_patterning_mode, 4, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.doubleSpinBox_spot_size, 7, 1, 1, 1)
        self.label_spot_size = QtWidgets.QLabel(self.groupBox_milling_settings)
        self.label_spot_size.setObjectName("label_spot_size")
        self.gridLayout_3.addWidget(self.label_spot_size, 7, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.spinBox_voltage, 0, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.doubleSpinBox_dwell_time, 6, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.doubleSpinBox_milling_current, 1, 1, 1, 1)
        self.gridLayout_2.addWidget(self.groupBox_milling_settings, 0, 0, 1, 1)
        self.groupBox_drift_correction = QtWidgets.QGroupBox(self.scrollAreaWidgetContents)
        self.groupBox_drift_correction.setObjectName("groupBox_drift_correction")
        self.gridLayout_7 = QtWidgets.QGridLayout(self.groupBox_drift_correction)
        self.gridLayout_7.setObjectName("gridLayout_7")
        self.checkBox_drift_correction_enabled = QtWidgets.QCheckBox(self.groupBox_drift_correction)
        self.checkBox_drift_correction_enabled.setObjectName("checkBox_drift_correction_enabled")
        self.gridLayout_7.addWidget(self.checkBox_drift_correction_enabled, 1, 0, 1, 1)
        self.checkBox_drift_correction_interval_enabled = QtWidgets.QCheckBox(self.groupBox_drift_correction)
        self.checkBox_drift_correction_interval_enabled.setObjectName("checkBox_drift_correction_interval_enabled")
        self.gridLayout_7.addWidget(self.checkBox_drift_correction_interval_enabled, 1, 1, 1, 1)
        self.doubleSpinBox_drift_correction_interval = QtWidgets.QDoubleSpinBox(self.groupBox_drift_correction)
        self.doubleSpinBox_drift_correction_interval.setObjectName("doubleSpinBox_drift_correction_interval")
        self.gridLayout_7.addWidget(self.doubleSpinBox_drift_correction_interval, 2, 1, 1, 1)
        self.label_drift_correction_interval = QtWidgets.QLabel(self.groupBox_drift_correction)
        self.label_drift_correction_interval.setObjectName("label_drift_correction_interval")
        self.gridLayout_7.addWidget(self.label_drift_correction_interval, 2, 0, 1, 1)
        self.pushButton_drift_correction_edit_area = QtWidgets.QPushButton(self.groupBox_drift_correction)
        self.pushButton_drift_correction_edit_area.setObjectName("pushButton_drift_correction_edit_area")
        self.gridLayout_7.addWidget(self.pushButton_drift_correction_edit_area, 4, 1, 1, 1)
        self.gridLayout_2.addWidget(self.groupBox_drift_correction, 1, 0, 1, 1)
        ...
        self.gridLayout_5.addLayout(self.gridLayout_patterns, 2, 0, 1, 3)
        ...
        self.gridLayout.addWidget(self.progressBar_milling, 27, 0, 1, 2)
        ...
        self.gridLayout.addItem(spacerItem, 28, 0, 1, 2)
    ...
    def retranslateUi(self, Form):
        ...
        self.groupBox_drift_correction.setTitle(_translate("Form", "Drift Correction"))
        self.checkBox_drift_correction_enabled.setText(_translate("Form", "Initial Alignment"))
        self.checkBox_drift_correction_interval_enabled.setText(_translate("Form", "Interval Alignment"))
        self.label_drift_correction_interval.setText(_translate("Form", "Interval (s)"))
        self.pushButton_drift_correction_edit_area.setText(_translate("Form", "Edit Alignment Area"))
