...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout_4.addWidget(self.doubleSpinBox_centre_x, 23, 1, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.checkBox_relative_move, 29, 1, 1, 1)
        self.label_pattern_set = QtWidgets.QLabel(self.frame)
        self.label_pattern_set.setObjectName("label_pattern_set")
        self.gridLayout_4.addWidget(self.label_pattern_set, 21, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.label_milling_instructions, 31, 0, 1, 2)
        ...
        self.gridLayout_4.addWidget(self.label_patterns_header, 19, 0, 1, 2)
        self.pushButton = QtWidgets.QPushButton(self.frame)
        self.pushButton.setObjectName("pushButton")
        self.gridLayout_4.addWidget(self.pushButton, 32, 0, 1, 2)
        self.comboBox_patterns = QtWidgets.QComboBox(self.frame)
        self.comboBox_patterns.setObjectName("comboBox_patterns")
        self.gridLayout_4.addWidget(self.comboBox_patterns, 21, 1, 1, 1)
        self.pushButton_edit_drift_correction_area = QtWidgets.QPushButton(self.frame)
        self.pushButton_edit_drift_correction_area.setObjectName("pushButton_edit_drift_correction_area")
        self.gridLayout_4.addWidget(self.pushButton_edit_drift_correction_area, 15, 1, 1, 1)
        self.gridLayout_patterns = QtWidgets.QGridLayout()
        self.gridLayout_patterns.setObjectName("gridLayout_patterns")
        self.gridLayout_4.addLayout(self.gridLayout_patterns, 26, 0, 2, 2)
        ...
        self.checkBox_milling_drift_correction = QtWidgets.QCheckBox(self.frame)
        self.checkBox_milling_drift_correction.setObjectName("checkBox_milling_drift_correction")
        self.gridLayout_4.addWidget(self.checkBox_milling_drift_correction, 15, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.doubleSpinBox_centre_y, 24, 1, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.label_centre_y, 24, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.line_2, 18, 0, 1, 2)
        ...
        self.gridLayout_4.addWidget(self.label_centre_x, 23, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.checkBox_live_update, 29, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.checkBox_show_milling_crosshair, 30, 1, 1, 1)
        self.label_milling_drift_correction_interval = QtWidgets.QLabel(self.frame)
        self.label_milling_drift_correction_interval.setObjectName("label_milling_drift_correction_interval")
        self.gridLayout_4.addWidget(self.label_milling_drift_correction_interval, 16, 0, 1, 1)
        self.spinBox_milling_drift_correction_interval = QtWidgets.QSpinBox(self.frame)
        self.spinBox_milling_drift_correction_interval.setObjectName("spinBox_milling_drift_correction_interval")
        self.gridLayout_4.addWidget(self.spinBox_milling_drift_correction_interval, 16, 1, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButton_edit_drift_correction_area.setText(_translate("Form", "Edit Alignment Area"))
        self.checkBox_milling_drift_correction.setText(_translate("Form", "Drift Correction"))
        ...
        self.label_milling_drift_correction_interval.setText(_translate("Form", "Drift Correction Interval (s)"))
