...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout_4.addWidget(self.doubleSpinBox_centre_y, 18, 1, 1, 1)
        ...
        self.gridLayout_4.addItem(spacerItem, 22, 0, 1, 2)
        ...
        self.gridLayout_4.addWidget(self.label_pattern_set, 15, 0, 1, 1)
        self.pushButton = QtWidgets.QPushButton(self.tab_patterns)
        self.pushButton.setObjectName("pushButton")
        self.gridLayout_4.addWidget(self.pushButton, 24, 0, 1, 2)
        ...
        self.gridLayout_4.addWidget(self.doubleSpinBox_centre_x, 17, 1, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.comboBox_patterns, 15, 1, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.label_centre_y, 18, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.label_centre_x, 17, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.checkBox_live_update, 23, 0, 1, 1)
        self.pushButton_2 = QtWidgets.QPushButton(self.tab_patterns)
        self.pushButton_2.setObjectName("pushButton_2")
        self.gridLayout_4.addWidget(self.pushButton_2, 14, 0, 1, 1)
        self.pushButton_3 = QtWidgets.QPushButton(self.tab_patterns)
        self.pushButton_3.setObjectName("pushButton_3")
        self.gridLayout_4.addWidget(self.pushButton_3, 14, 1, 1, 1)
        self.gridLayout_patterns = QtWidgets.QGridLayout()
        self.gridLayout_patterns.setObjectName("gridLayout_patterns")
        self.gridLayout_4.addLayout(self.gridLayout_patterns, 20, 0, 2, 2)
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButton_2.setText(_translate("Form", "Load Bitmap Pattern"))
        self.pushButton_3.setText(_translate("Form", "Clear Bitmap Pattern"))
