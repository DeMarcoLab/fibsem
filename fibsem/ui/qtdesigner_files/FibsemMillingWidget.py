...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout.addWidget(self.label_info, 27, 0, 1, 2)
        ...
        self.checkBox_move_all_patterns = QtWidgets.QCheckBox(self.frame)
        self.checkBox_move_all_patterns.setObjectName("checkBox_move_all_patterns")
        self.gridLayout_4.addWidget(self.checkBox_move_all_patterns, 26, 0, 1, 1)
