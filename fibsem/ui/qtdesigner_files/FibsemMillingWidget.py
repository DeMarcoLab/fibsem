...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.checkBox_live_update = QtWidgets.QCheckBox(Form)
        self.checkBox_live_update.setObjectName("checkBox_live_update")
        self.gridLayout.addWidget(self.checkBox_live_update, 18, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.pushButton, 26, 0, 1, 2)
        ...
        self.gridLayout_4.addWidget(self.label_spot_size, 9, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.label_centre_y, 17, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.doubleSpinBox_centre_x, 16, 1, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.doubleSpinBox_centre_y, 17, 1, 1, 1)
        self.label_centre_x = QtWidgets.QLabel(self.tab_patterns)
        self.label_centre_x.setObjectName("label_centre_x")
        self.gridLayout_4.addWidget(self.label_centre_x, 16, 0, 1, 1)
        ...
        self.pushButton_save_milling_stage = QtWidgets.QPushButton(self.tab_patterns)
        self.pushButton_save_milling_stage.setObjectName("pushButton_save_milling_stage")
        self.gridLayout_4.addWidget(self.pushButton_save_milling_stage, 21, 0, 1, 2)
        ...
        self.gridLayout_4.addWidget(self.line_2, 12, 0, 1, 2)
        ...
        self.gridLayout_4.addWidget(self.label_pattern_set, 14, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.label_patterns_header, 13, 0, 1, 2)
        self.gridLayout_patterns = QtWidgets.QGridLayout()
        self.gridLayout_patterns.setObjectName("gridLayout_patterns")
        self.gridLayout_4.addLayout(self.gridLayout_patterns, 19, 0, 1, 2)
        ...
        self.gridLayout_4.addWidget(self.label_preset, 11, 0, 1, 1)
        self.comboBox_preset = QtWidgets.QComboBox(self.tab_patterns)
        self.comboBox_preset.setObjectName("comboBox_preset")
        self.gridLayout_4.addWidget(self.comboBox_preset, 11, 1, 1, 1)
        ...
        self.pushButton_test_button = QtWidgets.QPushButton(Form)
        self.pushButton_test_button.setObjectName("pushButton_test_button")
        self.gridLayout.addWidget(self.pushButton_test_button, 30, 0, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButton_save_milling_stage.setText(_translate("Form", "Save Milling Stage"))
        ...
        self.pushButton_test_button.setText(_translate("Form", "Test"))
