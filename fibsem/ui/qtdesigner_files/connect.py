...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayoutWidget_2.setGeometry(QtCore.QRect(0, 0, 421, 391))
        ...
        self.gridLayout_2.addWidget(self.ResetImage, 10, 2, 1, 2)
        ...
        self.EB_Click = QtWidgets.QPushButton(self.gridLayoutWidget_2)
        self.EB_Click.setObjectName("EB_Click")
        self.gridLayout_2.addWidget(self.EB_Click, 13, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.label_2, 12, 2, 1, 2)
        self.IB_Save = QtWidgets.QPushButton(self.gridLayoutWidget_2)
        self.IB_Save.setObjectName("IB_Save")
        self.gridLayout_2.addWidget(self.IB_Save, 13, 3, 1, 1)
        self.EB_Save = QtWidgets.QPushButton(self.gridLayoutWidget_2)
        self.EB_Save.setObjectName("EB_Save")
        self.gridLayout_2.addWidget(self.EB_Save, 13, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.autosave_enable, 6, 1, 1, 1)
        ...
        self.IB_click = QtWidgets.QPushButton(self.gridLayoutWidget_2)
        self.IB_click.setObjectName("IB_click")
        self.gridLayout_2.addWidget(self.IB_click, 13, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.label, 12, 0, 1, 2)
        ...
        self.gridLayout_2.addWidget(self.hfw_box, 7, 1, 1, 1)
        spacerItem1 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_2.addItem(spacerItem1, 11, 0, 1, 4)
        ...
        self.gridLayout_2.addWidget(self.reset_image_settings, 9, 1, 1, 2)
