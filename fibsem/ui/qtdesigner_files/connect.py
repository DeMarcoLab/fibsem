...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.doubleSpinBox_milling_current = QtWidgets.QDoubleSpinBox(self.verticalLayoutWidget_3)
        self.doubleSpinBox_milling_current.setObjectName("doubleSpinBox_milling_current")
        self.gridLayout_3.addWidget(self.doubleSpinBox_milling_current, 5, 1, 1, 1)
        ...
        self.doubleSpinBox_center_x = QtWidgets.QDoubleSpinBox(self.verticalLayoutWidget_3)
        self.doubleSpinBox_center_x.setObjectName("doubleSpinBox_center_x")
        self.gridLayout_3.addWidget(self.doubleSpinBox_center_x, 4, 1, 1, 1)
        ...
        self.doubleSpinBox_center_y = QtWidgets.QDoubleSpinBox(self.verticalLayoutWidget_3)
        self.doubleSpinBox_center_y.setObjectName("doubleSpinBox_center_y")
        self.gridLayout_3.addWidget(self.doubleSpinBox_center_y, 4, 4, 1, 1)
        self.doubleSpinBox_height = QtWidgets.QDoubleSpinBox(self.verticalLayoutWidget_3)
        self.doubleSpinBox_height.setObjectName("doubleSpinBox_height")
        self.gridLayout_3.addWidget(self.doubleSpinBox_height, 2, 4, 1, 1)
        ...
        self.doubleSpinBox_rotation = QtWidgets.QDoubleSpinBox(self.verticalLayoutWidget_3)
        self.doubleSpinBox_rotation.setObjectName("doubleSpinBox_rotation")
        self.gridLayout_3.addWidget(self.doubleSpinBox_rotation, 3, 4, 1, 1)
        ...
        self.doubleSpinBox_width_2 = QtWidgets.QDoubleSpinBox(self.verticalLayoutWidget_3)
        self.doubleSpinBox_width_2.setObjectName("doubleSpinBox_width_2")
        self.gridLayout_3.addWidget(self.doubleSpinBox_width_2, 3, 1, 1, 1)
        self.doubleSpinBox_width = QtWidgets.QDoubleSpinBox(self.verticalLayoutWidget_3)
        self.doubleSpinBox_width.setObjectName("doubleSpinBox_width")
        self.gridLayout_3.addWidget(self.doubleSpinBox_width, 2, 1, 1, 1)
        ...
        self.comboBox_scan_direction = QtWidgets.QComboBox(self.verticalLayoutWidget_3)
        self.comboBox_scan_direction.setObjectName("comboBox_scan_direction")
        self.comboBox_scan_direction.addItem("")
        self.comboBox_scan_direction.addItem("")
        self.comboBox_scan_direction.addItem("")
        self.gridLayout_3.addWidget(self.comboBox_scan_direction, 5, 4, 1, 2)
        self.comboBox_pattern = QtWidgets.QComboBox(self.verticalLayoutWidget_3)
        self.comboBox_pattern.setObjectName("comboBox_pattern")
        self.comboBox_pattern.addItem("")
        self.comboBox_pattern.addItem("")
        self.comboBox_pattern.addItem("")
        self.comboBox_pattern.addItem("")
        self.gridLayout_3.addWidget(self.comboBox_pattern, 6, 4, 1, 2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_49.setText(_translate("MainWindow", "mA"))
        ...
        self.comboBox_scan_direction.setItemText(0, _translate("MainWindow", "TopToBottom"))
        self.comboBox_scan_direction.setItemText(1, _translate("MainWindow", "BottomToTop"))
        self.comboBox_scan_direction.setItemText(2, _translate("MainWindow", "ZigZag"))
        self.comboBox_pattern.setItemText(0, _translate("MainWindow", "Rectangle"))
        self.comboBox_pattern.setItemText(1, _translate("MainWindow", "Also Rectangle"))
        self.comboBox_pattern.setItemText(2, _translate("MainWindow", "Another Rectangle"))
        self.comboBox_pattern.setItemText(3, _translate("MainWindow", "One Rectangle Please"))
