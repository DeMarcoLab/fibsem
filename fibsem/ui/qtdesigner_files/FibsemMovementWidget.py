...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout_2.addWidget(self.pushButton_continue, 11, 0, 1, 2)
        ...
        self.gridLayout_2.addWidget(self.label_movement_instructions, 10, 0, 1, 2)
        ...
        self.pushButton_auto_eucentric = QtWidgets.QPushButton(self.tab_movement)
        self.pushButton_auto_eucentric.setObjectName("pushButton_auto_eucentric")
        self.gridLayout_2.addWidget(self.pushButton_auto_eucentric, 9, 1, 1, 1)
        ...
        self.spinBox_x_lower = QtWidgets.QSpinBox(self.tab_positions)
        self.spinBox_x_lower.setObjectName("spinBox_x_lower")
        self.gridLayout_3.addWidget(self.spinBox_x_lower, 7, 2, 1, 1)
        ...
        self.checkBox = QtWidgets.QCheckBox(self.tab_positions)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_5.setText(_translate("Form", "Grid size (um)"))
        ...
        self.checkBox.setText(_translate("Form", "Auto scaling"))
