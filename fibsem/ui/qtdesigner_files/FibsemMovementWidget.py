...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.pushButton_tile_manager = QtWidgets.QPushButton(self.tab_positions)
        self.pushButton_tile_manager.setObjectName("pushButton_tile_manager")
        self.gridLayout_3.addWidget(self.pushButton_tile_manager, 10, 1, 1, 3)
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButton_tile_manager.setText(_translate("Form", "Open Tile Manager"))
