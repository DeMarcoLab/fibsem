...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.checkBox_gridbar = QtWidgets.QCheckBox(self.tab)
        self.checkBox_gridbar.setObjectName("checkBox_gridbar")
        self.gridLayout_2.addWidget(self.checkBox_gridbar, 8, 0, 1, 1)
        self.gb_spacing = QtWidgets.QLabel(self.tab)
        self.gb_spacing.setObjectName("gb_spacing")
        self.gridLayout_2.addWidget(self.gb_spacing, 10, 0, 1, 1)
        ...
        self.gb_x = QtWidgets.QLabel(self.tab)
        self.gb_x.setObjectName("gb_x")
        self.gridLayout_2.addWidget(self.gb_x, 11, 0, 1, 1)
        self.gb_width = QtWidgets.QLabel(self.tab)
        self.gb_width.setObjectName("gb_width")
        self.gridLayout_2.addWidget(self.gb_width, 9, 0, 1, 1)
        self.gb_y = QtWidgets.QLabel(self.tab)
        self.gb_y.setObjectName("gb_y")
        self.gridLayout_2.addWidget(self.gb_y, 12, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.pushButton_run_tile_collection, 14, 0, 1, 2)
        ...
        self.gb_r = QtWidgets.QLabel(self.tab)
        self.gb_r.setObjectName("gb_r")
        self.gridLayout_2.addWidget(self.gb_r, 13, 0, 1, 1)
        self.doubleSpinBox_gb_width = QtWidgets.QDoubleSpinBox(self.tab)
        self.doubleSpinBox_gb_width.setMinimum(-100000.0)
        self.doubleSpinBox_gb_width.setMaximum(100000.0)
        self.doubleSpinBox_gb_width.setObjectName("doubleSpinBox_gb_width")
        self.gridLayout_2.addWidget(self.doubleSpinBox_gb_width, 9, 1, 1, 1)
        self.doubleSpinBox_gb_spacing = QtWidgets.QDoubleSpinBox(self.tab)
        self.doubleSpinBox_gb_spacing.setMinimum(-100000.0)
        self.doubleSpinBox_gb_spacing.setMaximum(100000.0)
        self.doubleSpinBox_gb_spacing.setObjectName("doubleSpinBox_gb_spacing")
        self.gridLayout_2.addWidget(self.doubleSpinBox_gb_spacing, 10, 1, 1, 1)
        self.doubleSpinBox_gb_x = QtWidgets.QDoubleSpinBox(self.tab)
        self.doubleSpinBox_gb_x.setMinimum(-100000.0)
        self.doubleSpinBox_gb_x.setMaximum(100000.0)
        self.doubleSpinBox_gb_x.setObjectName("doubleSpinBox_gb_x")
        self.gridLayout_2.addWidget(self.doubleSpinBox_gb_x, 11, 1, 1, 1)
        self.doubleSpinBox_gb_y = QtWidgets.QDoubleSpinBox(self.tab)
        self.doubleSpinBox_gb_y.setMinimum(-100000.0)
        self.doubleSpinBox_gb_y.setMaximum(100000.0)
        self.doubleSpinBox_gb_y.setObjectName("doubleSpinBox_gb_y")
        self.gridLayout_2.addWidget(self.doubleSpinBox_gb_y, 12, 1, 1, 1)
        self.doubleSpinBox_gb_r = QtWidgets.QDoubleSpinBox(self.tab)
        self.doubleSpinBox_gb_r.setMinimum(-100000.0)
        self.doubleSpinBox_gb_r.setMaximum(100000.0)
        self.doubleSpinBox_gb_r.setObjectName("doubleSpinBox_gb_r")
        self.gridLayout_2.addWidget(self.doubleSpinBox_gb_r, 13, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.gb_spacing.setText(_translate("MainWindow", "Gridbar Spacing (um)"))
        ...
        self.gb_x.setText(_translate("MainWindow", "Translate X (px)"))
        self.gb_width.setText(_translate("MainWindow", "Gridbar Width (um)"))
        self.gb_y.setText(_translate("MainWindow", "Translate Y (px)"))
        ...
        self.gb_r.setText(_translate("MainWindow", "Rotate (deg)"))
