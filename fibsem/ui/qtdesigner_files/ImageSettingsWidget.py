...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout.addWidget(self.shift_x, 23, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.spinBox_resolution_x, 5, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.detector_contrast_slider, 17, 1, 1, 1)
        ...
        self.label_detector_type = QtWidgets.QLabel(Form)
        self.label_detector_type.setObjectName("label_detector_type")
        self.gridLayout.addWidget(self.label_detector_type, 14, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.doubleSpinBox_image_hfw, 7, 1, 1, 1)
        self.radioButton_beginner_mode = QtWidgets.QRadioButton(Form)
        self.radioButton_beginner_mode.setObjectName("radioButton_beginner_mode")
        self.gridLayout.addWidget(self.radioButton_beginner_mode, 0, 0, 1, 1)
        self.detector_mode_combobox = QtWidgets.QComboBox(Form)
        self.detector_mode_combobox.setObjectName("detector_mode_combobox")
        self.gridLayout.addWidget(self.detector_mode_combobox, 15, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.spinBox_resolution_y, 5, 2, 1, 1)
        spacerItem = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout.addItem(spacerItem, 30, 0, 1, 3)
        ...
        self.gridLayout.addWidget(self.crosshair_checkbox, 25, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.detector_brightness_slider, 16, 1, 1, 1)
        spacerItem1 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout.addItem(spacerItem1, 26, 0, 1, 3)
        ...
        self.gridLayout.addWidget(self.button_set_beam_settings, 18, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.checkBox_image_use_autocontrast, 9, 0, 1, 1)
        self.label_shift = QtWidgets.QLabel(Form)
        self.label_shift.setObjectName("label_shift")
        self.gridLayout.addWidget(self.label_shift, 23, 0, 1, 1)
        self.label_image_label = QtWidgets.QLabel(Form)
        self.label_image_label.setObjectName("label_image_label")
        self.gridLayout.addWidget(self.label_image_label, 12, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.detector_brightness_label, 16, 2, 1, 1)
        self.label_image_resolution = QtWidgets.QLabel(Form)
        self.label_image_resolution.setObjectName("label_image_resolution")
        self.gridLayout.addWidget(self.label_image_resolution, 5, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.beam_voltage, 21, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.working_distance, 19, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_presets, 8, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.checkBox_image_use_autogamma, 9, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.checkBox_image_save_image, 10, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.pushButton_live_imaging, 29, 0, 1, 3)
        ...
        self.gridLayout.addWidget(self.stigmation_x, 22, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.beam_current, 20, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.doubleSpinBox_image_dwell_time, 6, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.scalebar_checkbox, 25, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.pushButton_take_all_images, 28, 0, 1, 3)
        ...
        self.label_detector_mode = QtWidgets.QLabel(Form)
        self.label_detector_mode.setObjectName("label_detector_mode")
        self.gridLayout.addWidget(self.label_detector_mode, 15, 0, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.radioButton_beginner_mode.setText(_translate("Form", "Beginner Mode"))
        ...
        self.radioButton_2.setText(_translate("Form", "Advanced Mode"))
