...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout_2.addWidget(self.dX_spinbox, 5, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.dx_label, 5, 0, 1, 1)
        self.goToPosition_button = QtWidgets.QPushButton(Form)
        self.goToPosition_button.setObjectName("goToPosition_button")
        self.gridLayout_2.addWidget(self.goToPosition_button, 12, 0, 1, 1)
        ...
        self.beam_type_combobox.addItem("")
        self.gridLayout_2.addWidget(self.beam_type_combobox, 9, 1, 1, 1)
        self.beam_type_label = QtWidgets.QLabel(Form)
        self.beam_type_label.setObjectName("beam_type_label")
        self.gridLayout_2.addWidget(self.beam_type_label, 9, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.savedPositionName_lineEdit, 11, 1, 1, 1)
        self.dr_label = QtWidgets.QLabel(Form)
        self.dr_label.setObjectName("dr_label")
        self.gridLayout_2.addWidget(self.dr_label, 8, 0, 1, 1)
        self.dz_label = QtWidgets.QLabel(Form)
        self.dz_label.setObjectName("dz_label")
        self.gridLayout_2.addWidget(self.dz_label, 7, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.dZ_spinbox, 7, 1, 1, 1)
        self.dy_label = QtWidgets.QLabel(Form)
        self.dy_label.setObjectName("dy_label")
        self.gridLayout_2.addWidget(self.dy_label, 6, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.addSavedPosition_button, 11, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.dR_spinbox, 8, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.moveRelative_button, 10, 0, 1, 2)
        ...
        self.move_type_comboBox.addItem("")
        self.gridLayout_2.addWidget(self.move_type_comboBox, 4, 0, 1, 2)
