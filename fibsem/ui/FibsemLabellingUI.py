...
INSTRUCTIONS = {"data": "Select the folder containing the raw data\n",
...
class FibsemLabellingUI(FibsemLabellingUI.Ui_Dialog, QtWidgets.QDialog):
    ...
    def load_model(self):
        ...
        if self.model_type == "SegmentAnythingModel":
            ...
            self.comboBox_model_class_index.addItems([f"Class {i:02d}" for i in range(self.model.num_classes)])
