...
class FibsemStagePosition:
    ...
    if THERMO:
        ...
        def to_autoscript_position(self, compustage: bool = False) -> StagePosition | CompustagePosition:
        ...
        def from_autoscript_position(
            cls, position: StagePosition | CompustagePosition
        ) -> "FibsemStagePosition":
            # compustage position
...
class ImageSettings:
    ...
    autogamma: bool | None = None
    path: str | os.PathLike[str] | None = None
    reduced_area: FibsemRectangle | None = None
    line_integration: int | None = None  # (int32) 2 - 255
    scan_interlacing: int | None = None  # (int32) 2 - 8
    frame_integration: int | None = None  # (int32) 2 - 512
...
class MicroscopeState:
    ...
    @classmethod
    def from_dict(cls, state_dict: dict) -> "MicroscopeState":
...
class FibsemMillingSettings:
    ...
    @classmethod
    def from_dict(cls, settings: dict) -> "FibsemMillingSettings":
        milling_settings = cls(
...
class StageSystemSettings:
    ...
    @classmethod
    def from_dict(cls, settings: dict) -> "StageSystemSettings":
        return cls(
...
class BeamSystemSettings:
    ...
    @classmethod
    def from_dict(cls, settings: dict[str, Any]) -> "BeamSystemSettings":
        return cls(
...
class ManipulatorSystemSettings:
    ...
    @staticmethod
    def from_dict(settings: dict[str, Any]):
...
class SystemInfo:
    ...
    @classmethod
    def from_dict(cls, settings: dict) -> "SystemInfo":
        return cls(
...
class SystemSettings:
    ...
    @classmethod
    def from_dict(cls, settings: dict) -> "SystemSettings":
...
class MicroscopeSettings:
    ...
    @classmethod
    def from_dict(
        cls, settings: dict[str, Any], protocol: dict[str, Any] | None = None
    ) -> "MicroscopeSettings":
        if protocol is None:
...
class FibsemExperiment:
    ...
    @classmethod
    def from_dict(cls, settings: dict) -> "FibsemExperiment":
        """Converts from a dictionary."""
        return cls(
...
class FibsemUser:
    ...
    @classmethod
    def from_dict(cls, settings: dict) -> "FibsemUser":
        """Converts from a dictionary."""
        return FibsemUser(
            name=settings.get("name", "Unknown"),
...
class FibsemImageMetadata:
    ...
    @classmethod
    def from_dict(cls, settings: dict) -> "FibsemImageMetadata":
...
class FibsemImage:
    ...
    Args:
        data (NDArray[Any]): The image data stored in a numpy array.
    ...
    def __init__(
        self, data: NDArray[Any], metadata: FibsemImageMetadata | None = None
    ) -> None:
    ...
    def save(self, path: str | os.PathLike[str] | None = None) -> None:
        ...
        if path is None:
            if self.metadata is None:
                raise ValueError(
                    "Cannot save as no path was specified and attribute 'metadata' is None"
                )
            path = os.path.join(
    ...
    def _save_ome_tiff(self, path: str | os.PathLike[str], filename: str) -> None:
    ...
    if THERMO:
        ...
        def fromAdornedImage(
            ...
            image_settings: ImageSettings,
            state: MicroscopeState | None = None,
        ) -> "FibsemImage":
...
class ReferenceImages:
    ...
    def __iter__(
        ...
        tuple[FibsemImage, FibsemImage, FibsemImage, FibsemImage], None, None
    ]:
...
class FibsemGasInjectionSettings:
    ...
    gas: str
    duration: float
    insert_position: str | None = None  # multichem only
