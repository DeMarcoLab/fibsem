...
def setup_milling(
    ...
    try:
        ...
        raise Exception(f"""There is no patterning application with name: '{application_file}'. 
        Please see the INSTALLATION.md file for instructions on how to install the {application_file} application file.""")
